...
label bar1_solo_drink_mod:
    ...
    if total_chars > 0:
        ...
        $ renpy.call(enabled_chars[chance-1] + "_bar_intro")
        $ renpy.jump(enabled_chars[chance-1] + "_conversation_init")
